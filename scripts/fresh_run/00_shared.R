...
for (f in c(
  "PAGe/R/utils.R", "PAGe/R/m0_retro.R", "PAGe/R/m0_training.R", "PAGe/R/flagIgnition.R",
  "PAGe/R/m1_reference_helpers.R", "PAGe/R/m1_reference.R", "PAGe/R/m1_hyperparams.R",
  "PAGe/R/m1_multi_template.R", "PAGe/R/m1_loso.R", "PAGe/R/m1_fit.R",
  "PAGe/R/m2_spec_grid.R", "PAGe/R/m2_training.R",
  "PAGe/R/m2_loso_utils.R", "PAGe/R/m2_loso_fold.R", "PAGe/R/m2_loso_eval.R", "PAGe/R/m2_loso_cv.R",
