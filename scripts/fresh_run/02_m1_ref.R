...
# on historical training seasons (excl. 2011-12, 2015-16, 2020-21, 2021-22,
# and the prospective 2025-26 holdout).
#
...
# Historical training set; load_allD() also excludes the prospective holdout.
allD_prod <- load_allD(exclude = c("2011-12", "2015-16", "2020-21", "2021-22"))
train_seas <- sort(unique(allD_prod$season))
cat("Historical training seasons:", paste(train_seas, collapse = ", "), "\n")
