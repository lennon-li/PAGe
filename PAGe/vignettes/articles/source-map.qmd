...
The high-level public API follows five verbs: build, tune, train, assemble, and
run. Lower-level functions remain documented for advanced diagnostics and
method development, but operational code should prefer the high-level entry
points shown in the [walkthrough](pipeline-walkthrough.html).
