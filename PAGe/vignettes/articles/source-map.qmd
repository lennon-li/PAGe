...
The installable package under `PAGe/` is the sole source of truth. Its R source
lives under `PAGe/R/`. A top-level `R/` directory remains as a legacy checkout
mirror for historical scripts; do not edit it or add new package code there.
