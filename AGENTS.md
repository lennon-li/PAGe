...
- `seasonal-forecast` — Train, tune, evaluate, replay, or deploy the PAGe seasonal respiratory virus forecasting pipeline. Covers the M0 → M1 → M2 chain plus the governed acceptance → refresh → promotion release workflow.
